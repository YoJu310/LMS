...
const Player = () => {
  ...
  const { enrolledCourses, calculateChapterTime, backendUrl, 
    getToken, userData, fetchUserEnrolledCourses} = useContext(AppContext);
                     ...
                     border-gray-300'>
                      {chapter.chapterContent.map((lecture, i)=>(
                        <li key={i}  className='flex items-start gap-2 py-1'>
                          ...
                          assets.blue_tick_icon : assets.play_icon} alt='play icon' 
